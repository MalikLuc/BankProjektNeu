...
public class Girokonto extends Konto implements Ueberweisungsfaehig{
	...
	/**
	 * Sie wechselt die Währung, in der das Konto aktuell geführt wird. Der Kontostand
	 * müssen natürlich entsprechend umgerechnet werden.
	...
	public void waehrungswechsel(Waehrung neu) {
		...
		setDispo(this.getAktuelleWaehrung().kontowaehrungInWaehrung(getDispo(),neu));
		setWaehrung(neu);
	}
